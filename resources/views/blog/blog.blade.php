...
<div class="row">
    <div class="col-md-8">
        ...
        <div class="card text-center">
            ...
            <div class="card-body">
                ...
                <a href="{{ url('/blog/'.$post->category_id) }}"> <span
                        class="badge badge-primary">{{ $post->category->name }} </span> </a>
            </div>
        </div>
        @endforeach
    </div>
    <div class="col-md-4">
        ...
        <ul class="list-group">
            <li class="list-group-item @if(!$id) active @endif"> <a class="list-group-item-action"
                    href="{{ url('/blog/') }}"> All </a></li>
            @foreach($mycategories as $category)
            <li
                class="list-group-item d-flex justify-content-between align-items-center @if($category->id == $id) active @endif">
